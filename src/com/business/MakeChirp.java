...
public class MakeChirp {
	...
	public void MakeRandomChirp() {
		double randDuation = Math.random(); //get random duration such that 0 < duration < 1.0 ; I went this way because I figured 1 second was long enough for a bird chrip
